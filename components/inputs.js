    ...
    return (
        <div className={`${classBox} flex_center my-3 py-3 border-dashed border-2 border-[#d9d9d9]`}>
            <div className="flex flex-col items-center justify-center gap-3 min-h-[235px]">
                ...
                <button className='w-[150px] py-2 border border-[#d9d9d9] hover:border-[#1890ff] hover:text-[#1890ff] outline-none c text-black font-extralight tracking-widest uppercase' onClick={handleButtonClick}>Upload File</button>
                <input
                    type="file"
                    ref={fileInputRef}
